...
//   get mean() {
//     return this.cache.mean ?? (this.cache.mean = mean(this.series));
//   }

//   get median() {
//     return this.cache.median ?? (this.cache.median = median(this.series));
//   }

//   // get std() {
//   //   return this.cache.std ?? (this.cache.std = std(this.series));
//   // }

//   get spread() {
//     return this.cache.spread ?? (this.cache.spread = mathsStatisticsSpread(this.series));
//   }
// }
